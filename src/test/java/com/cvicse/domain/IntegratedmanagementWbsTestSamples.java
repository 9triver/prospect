...
public class IntegratedmanagementWbsTestSamples {

    public static IntegratedmanagementWbs getIntegratedmanagementWbsSample1() {
        return new IntegratedmanagementWbs()
            .id("id1")
    ...
    public static IntegratedmanagementWbs getIntegratedmanagementWbsSample2() {
        return new IntegratedmanagementWbs()
            .id("id2")
    ...
    public static IntegratedmanagementWbs getIntegratedmanagementWbsRandomSampleGenerator() {
        return new IntegratedmanagementWbs()
