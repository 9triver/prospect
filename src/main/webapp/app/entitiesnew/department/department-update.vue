    ...
    <div class="col-8">
      <form name="editForm" novalidate v-on:submit.prevent="save()">
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('jy1App.department.description')" for="department-description"></label>
            <el-input
              type="text"
              class="form-control"
              name="description"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('jy1App.department.role')" for="department-role"></label>
            <el-input
              type="text"
              class="form-control"
              name="role"
          ...
          <div class="form-group">
            <label v-text="t$('jy1App.department.pbs')" for="department-pbs"></label>
            <el-select
              collapse-tags
              value-key="id"
              class="form-control"
              ...
              multiple
              name="pbs"
              v-if="department.pbs !== undefined"
              v-model="department.pbs"
            >
              <el-option
                v-bind:value="getSelected(department.pbs, projectpbsOption, 'id')"
          ...
          <div class="form-group">
            <label v-text="t$('jy1App.department.wbs')" for="department-wbs"></label>
            <el-select
              collapse-tags
              value-key="id"
              class="form-control"
              ...
              multiple
              name="wbs"
              v-if="department.wbs !== undefined"
              v-model="department.wbs"
            >
              <el-option
                v-bind:value="getSelected(department.wbs, projectwbsOption, 'id')"
          ...
          <div class="form-group">
            <label v-text="t$('jy1App.department.workbag')" for="department-workbag"></label>
            <el-select
              collapse-tags
              value-key="id"
              class="form-control"
              id="department-workbags"
              data-cy="workbag"
              multiple
              name="workbag"
              v-if="department.workbags !== undefined"
              v-model="department.workbags"
            >
              <el-option
                v-bind:value="getSelected(department.workbags, workbagOption, 'id')"
