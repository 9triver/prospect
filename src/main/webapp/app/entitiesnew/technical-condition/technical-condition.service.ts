...
export default class TechnicalConditionService {
  ...
  public create(entity: ITechnicalCondition): Promise<ITechnicalCondition> {
    return new Promise<ITechnicalCondition>((resolve, reject) => {
      axios
  ...
  public update(entity: ITechnicalCondition): Promise<ITechnicalCondition> {
    return new Promise<ITechnicalCondition>((resolve, reject) => {
      axios
  ...
  public partialUpdate(entity: ITechnicalCondition): Promise<ITechnicalCondition> {
    return new Promise<ITechnicalCondition>((resolve, reject) => {
      axios
