    ...
    <div class="col-8">
      <form name="editForm" novalidate v-on:submit.prevent="save()">
        ...
        <div>
          ...
          <div class="form-group">
            <label v-text="t$('jy1App.officers.frontline')" for="officers-frontline"></label>
            <el-select
              collapse-tags
              value-key="id"
              class="form-control"
              id="officers-frontlines"
              data-cy="frontline"
              multiple
              name="frontline"
              v-if="officers.frontlines !== undefined"
              v-model="officers.frontlines"
            >
              <el-option
                v-bind:value="getSelected(officers.frontlines, frontlineOption, 'id')"
