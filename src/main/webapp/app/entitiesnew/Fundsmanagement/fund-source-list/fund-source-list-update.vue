    ...
    <div class="col-8">
      <form name="editForm" novalidate v-on:submit.prevent="save()">
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('jy1App.fundSourceList.wbsid')" for="fund-source-list-wbsid"></label>
            <el-input
              type="text"
              class="form-control"
              name="wbsid"
              id="fund-source-list-wbsid"
              data-cy="wbsid"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('jy1App.fundSourceList.wbsname')" for="fund-source-list-wbsname"></label>
            <el-input
              type="text"
              class="form-control"
              name="wbsname"
              id="fund-source-list-wbsname"
              data-cy="wbsname"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('jy1App.fundSourceList.contract')" for="fund-source-list-contract"></label>
            <el-select
              collapse-tags
              value-key="id"
              class="form-control"
              id="fund-source-list-contract"
              data-cy="contract"
              name="contract"
              v-model="fundSourceList.contract"
            >
              <el-option v-bind:value="null"></el-option>
              <el-option
                v-bind:value="
                  fundSourceList.contract && contractOption.id === fundSourceList.contract.id ? fundSourceList.contract : contractOption
                "
          ...
          <div class="form-group">
            <label v-text="t$('jy1App.fundSourceList.contractPayment')" for="fund-source-list-contractPayment"></label>
            <el-select
              collapse-tags
              value-key="id"
              class="form-control"
              id="fund-source-list-contractPayments"
              data-cy="contractPayment"
              multiple
              name="contractPayment"
              v-if="fundSourceList.contractPayments !== undefined"
              v-model="fundSourceList.contractPayments"
            >
              <el-option
                v-bind:value="getSelected(fundSourceList.contractPayments, contractPaymentOption, 'id')"
