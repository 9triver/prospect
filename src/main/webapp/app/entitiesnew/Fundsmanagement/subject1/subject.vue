  ...
  <div>
    ...
    <div class="table-responsive" v-if="subjects && subjects.length > 0">
      <el-table :data="subjects" style="width: 100%" border stripe fit v-loading="isFetching">
        <el-table-column min-width="150px" show-overflow-tooltip prop="id" label="序号">
        ...
        <el-table-column min-width="150px" show-overflow-tooltip prop="type" label="类型" :sortable="false">
          <template #default="scope">
