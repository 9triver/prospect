    ...
    <div class="table-responsive" v-if="paymentCostLists && paymentCostLists.length > 0">
      <el-table :data="paymentCostLists" style="width: 100%" border stripe fit v-loading="isFetching">
        ...
        <el-table-column
          ...
          show-overflow-tooltip
          prop="subjectid"
          :label="t$('jy1App.paymentCostList.subjectid')"
          :sortable="true"
        >
          <template #default="scope">
        ...
        <el-table-column
          ...
          show-overflow-tooltip
          prop="subjectname"
          :label="t$('jy1App.paymentCostList.subjectname')"
          :sortable="false"
        >
          <template #default="scope">
        ...
        <el-table-column min-width="150px" show-overflow-tooltip prop="workbag.id" :label="t$('jy1App.paymentCostList.workbag')">
          <template #default="scope">
            <td>
      ...
      <!-- <table class="table table-striped" aria-describedby="paymentCostLists">
                ...
                <tr>
                    ...
                    <th scope="row"><span v-text="t$('jy1App.paymentCostList.subjectid')"></span></th>
                    <th scope="row"><span v-text="t$('jy1App.paymentCostList.subjectname')"></span></th>
                    ...
                    <th scope="row"><span v-text="t$('jy1App.paymentCostList.workbag')"></span></th>
                ...
                <tr v-for="paymentCostList in paymentCostLists"
                    ...
                    <td>{{paymentCostList.subjectid}}</td>
                    <td>{{paymentCostList.subjectname}}</td>
                    ...
                    <td>
                        <div v-if="paymentCostList.workbag">
                            <router-link :to="{name: 'WorkbagView', params: {workbagId: paymentCostList.workbag.id}}">{{paymentCostList.workbag.id}}</router-link>
                        </div>
                    </td>
                    <td>
                        <span v-for="(contractPayment, i) in paymentCostList.contractPayments" :key="contractPayment.id">{{i > 0 ? ', ' : ''}}
