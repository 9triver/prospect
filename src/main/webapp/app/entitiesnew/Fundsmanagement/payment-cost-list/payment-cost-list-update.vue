    ...
    <div class="col-8">
      <form name="editForm" novalidate v-on:submit.prevent="save()">
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('jy1App.paymentCostList.subjectid')" for="payment-cost-list-subjectid"></label>
            <el-input
              type="number"
              class="form-control"
              name="subjectid"
              id="payment-cost-list-subjectid"
              data-cy="subjectid"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('jy1App.paymentCostList.subjectname')" for="payment-cost-list-subjectname"></label>
            <el-input
              type="text"
              class="form-control"
              name="subjectname"
              id="payment-cost-list-subjectname"
              data-cy="subjectname"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('jy1App.paymentCostList.workbag')" for="payment-cost-list-workbag"></label>
            <el-select
              collapse-tags
              value-key="id"
              class="form-control"
              id="payment-cost-list-workbag"
              data-cy="workbag"
              name="workbag"
              v-model="paymentCostList.workbag"
            >
              <el-option v-bind:value="null"></el-option>
              <el-option
                v-bind:value="
                  paymentCostList.workbag && workbagOption.id === paymentCostList.workbag.id ? paymentCostList.workbag : workbagOption
                "
          ...
          <div class="form-group">
            <label v-text="t$('jy1App.paymentCostList.contractPayment')" for="payment-cost-list-contractPayment"></label>
            <el-select
              collapse-tags
              value-key="id"
              class="form-control"
              id="payment-cost-list-contractPayments"
              data-cy="contractPayment"
              multiple
              name="contractPayment"
              v-if="paymentCostList.contractPayments !== undefined"
              v-model="paymentCostList.contractPayments"
            >
              <el-option
                v-bind:value="getSelected(paymentCostList.contractPayments, contractPaymentOption, 'id')"
