    ...
    <div class="table-responsive" v-if="projectBudgets && projectBudgets.length > 0">
      <el-table :data="projectBudgets" style="width: 100%" border stripe fit v-loading="isFetching">
        ...
        <el-table-column
          ...
          show-overflow-tooltip
          prop="contractcode"
          :label="t$('jy1App.projectBudget.contractcode')"
          :sortable="false"
        >
          <template #default="scope">
      ...
      <!-- <table class="table table-striped" aria-describedby="projectBudgets">
                ...
                <tr>
                    ...
                    <th scope="row"><span v-text="t$('jy1App.projectBudget.contractcode')"></span></th>
                ...
                <tr v-for="projectBudget in projectBudgets"
                    ...
                    <td>{{projectBudget.contractcode}}</td>
                    ...
                    <td>
                        <div v-if="projectBudget.projectwbs">
                            <router-link :to="{name: 'ProjectwbsView', params: {projectwbsId: projectBudget.projectwbs.id}}">{{projectBudget.projectwbs.id}}</router-link>
                        </div>
                    </td>
                    <td class="text-right">
                        <div class="btn-group">
