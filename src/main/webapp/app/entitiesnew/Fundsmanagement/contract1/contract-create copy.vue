    ...
    <el-tabs v-model="activeTab">
      <el-tab-pane label="科目经费" name="first">
        <div  class="form-group" v-if="subjectCostBudgets.length">
          <el-table :data="subjectCostBudgets" style="width: 100%; margin-top: 20px" row-key="id" border default-expand-all>
      ...
      <el-tab-pane label="系统内经费" name="second">
        <div  class="form-group" v-if="projectBudgets.length">
          <el-table :data="projectBudgets" style="width: 100%; margin-top: 20px" row-key="id" border default-expand-all>
            <el-table-column prop="id" label="编号" />
      ...
      <el-tab-pane label="科目经费" name="third">
        <div class="form-group" v-if="subjectCostBudgets.length">
          <el-table :data="subjectCostBudgets" style="width: 100%; margin-top: 20px" row-key="id" border default-expand-all>
            <el-table-column prop="id" label="编号" />
            <el-table-column prop="subjectname" label="科目" />
            <el-table-column label="预算金额">
              <template slot-scope="scope">
                <el-input v-model="scope.row.budgetamount" @change="updateBudgetAmount(scope.row)" />
              </template>
            </el-table-column>
            <el-table-column label="估算金额">
              <template slot-scope="scope">
                <el-input v-model="scope.row.estimatedamount" @change="updateEstimatedAmount(scope.row)" />
              </template>
            </el-table-column>
          </el-table>
          <el-button type="primary" @click="addToFirstTab">添加</el-button>
      ...
      <el-tab-pane label="系统内经费" name="fourth">
        <div class="form-group" v-if="projectBudgets.length">
          <el-table :data="projectBudgets" style="width: 100%; margin-top: 20px" row-key="id" border default-expand-all>
            <el-table-column prop="id" label="编号" />
            <el-table-column prop="wbsname" label="WBS名称" />
