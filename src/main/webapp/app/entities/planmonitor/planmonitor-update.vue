          ...
          <div class="form-group">
            ...
            <b-input-group class="mb-3">
              <b-input-group-prepend>
                <b-form-datepicker
                  aria-controls="planmonitor-month"
...
<script lang="ts" src="./planmonitor-update.component.ts"></script>
