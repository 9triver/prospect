...
export default class PlanmonitorService {
  ...
  public create(entity: IPlanmonitor): Promise<IPlanmonitor> {
    return new Promise<IPlanmonitor>((resolve, reject) => {
      axios
  ...
  public update(entity: IPlanmonitor): Promise<IPlanmonitor> {
    return new Promise<IPlanmonitor>((resolve, reject) => {
      axios
  ...
  public partialUpdate(entity: IPlanmonitor): Promise<IPlanmonitor> {
    return new Promise<IPlanmonitor>((resolve, reject) => {
      axios
