...
import { Qualitymanagement } from '@/shared/model/qualitymanagement.model';
...
describe('Service Tests', () => {
  describe('Qualitymanagement Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should not create a Qualitymanagement', async () => {
      ...
      it('should not update a Qualitymanagement', async () => {
      ...
      it('should not partial update a Qualitymanagement', async () => {
      ...
      it('should not return a list of Qualitymanagement', async () => {
        axiosStub.get.rejects(error);
      ...
      it('should not delete a Qualitymanagement', async () => {
