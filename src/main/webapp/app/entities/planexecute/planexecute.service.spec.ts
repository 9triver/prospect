...
import { Planexecute } from '@/shared/model/planexecute.model';
...
describe('Service Tests', () => {
  describe('Planexecute Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should not create a Planexecute', async () => {
      ...
      it('should update a Planexecute', async () => {
        const returnedFromService = Object.assign(
          {
            planname: 'BBBBBB',
            planstarttime: dayjs(currentDate).format(DATE_FORMAT),
      ...
      it('should not update a Planexecute', async () => {
      ...
      it('should not partial update a Planexecute', async () => {
      ...
      it('should return a list of Planexecute', async () => {
        const returnedFromService = Object.assign(
          {
            planname: 'BBBBBB',
            planstarttime: dayjs(currentDate).format(DATE_FORMAT),
      ...
      it('should not return a list of Planexecute', async () => {
        axiosStub.get.rejects(error);
      ...
      it('should not delete a Planexecute', async () => {
