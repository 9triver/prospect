...
export default class WbsbaselineService {
  ...
  public create(entity: IWbsbaseline): Promise<IWbsbaseline> {
    return new Promise<IWbsbaseline>((resolve, reject) => {
      axios
  ...
  public update(entity: IWbsbaseline): Promise<IWbsbaseline> {
    return new Promise<IWbsbaseline>((resolve, reject) => {
      axios
  ...
  public partialUpdate(entity: IWbsbaseline): Promise<IWbsbaseline> {
    return new Promise<IWbsbaseline>((resolve, reject) => {
      axios
