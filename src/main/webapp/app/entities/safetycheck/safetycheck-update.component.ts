      ...
      if (this.safetycheck.id) {
        this.safetycheckService()
          ...
          .then(param => {
            this.isSaving = false;
            this.previousState();
            this.alertService.showInfo(this.t$('jHipster0App.safetycheck.updated', { param: param.id }));
          })
          .catch(error => {
            this.isSaving = false;
        ...
        this.safetycheckService()
          ...
          .then(param => {
            this.isSaving = false;
            this.previousState();
            this.alertService.showSuccess(this.t$('jHipster0App.safetycheck.created', { param: param.id }).toString());
          })
          .catch(error => {
            this.isSaving = false;
            this.alertService.showHttpError(error.response);
