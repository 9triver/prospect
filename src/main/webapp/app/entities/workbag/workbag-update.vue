      ...
      <form name="editForm" novalidate v-on:submit.prevent="save()">
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('jy1App.workbag.name')" for="workbag-name"></label>
            <el-input
              type="text"
              class="form-control"
              name="name"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('jy1App.workbag.pbsid')" for="workbag-pbsid"></label>
            <el-input
              type="text"
              class="form-control"
              name="pbsid"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('jy1App.workbag.workbagtype')" for="workbag-workbagtype"></label>
            <el-input
              type="number"
              class="form-control"
              name="workbagtype"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('jy1App.workbag.supplier')" for="workbag-supplier"></label>
            <el-input
              type="text"
              class="form-control"
              name="supplier"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('jy1App.workbag.iskeyimportant')" for="workbag-iskeyimportant"></label>
            <el-input
              type="number"
              class="form-control"
              name="iskeyimportant"
