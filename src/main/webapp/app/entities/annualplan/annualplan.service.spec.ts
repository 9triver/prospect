...
import { Annualplan } from '@/shared/model/annualplan.model';
...
describe('Service Tests', () => {
  describe('Annualplan Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should not create a Annualplan', async () => {
      ...
      it('should not update a Annualplan', async () => {
      ...
      it('should not partial update a Annualplan', async () => {
      ...
      it('should not return a list of Annualplan', async () => {
        axiosStub.get.rejects(error);
      ...
      it('should not delete a Annualplan', async () => {
