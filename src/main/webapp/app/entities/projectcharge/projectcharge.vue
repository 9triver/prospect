<template>
  <div>
    <h2 id="page-heading" data-cy="ProjectchargeHeading">
      <span v-text="t$('jHipster3App.projectcharge.home.title')" id="projectcharge-heading"></span>
      <div class="d-flex justify-content-end">
        <button class="btn btn-info mr-2" v-on:click="handleSyncList" :disabled="isFetching">
          <font-awesome-icon icon="sync" :spin="isFetching"></font-awesome-icon>
          <span v-text="t$('jHipster3App.projectcharge.home.refreshListLabel')"></span>
        </button>
        <router-link :to="{ name: 'ProjectchargeCreate' }" custom v-slot="{ navigate }">
          ...
          >
            ...
            <span v-text="t$('jHipster3App.projectcharge.home.createLabel')"></span>
          </button>
        </router-link>
      </div>
    </h2>
    ...
    <div class="alert alert-warning" v-if="!isFetching && projectcharges && projectcharges.length === 0">
      <span v-text="t$('jHipster3App.projectcharge.home.notFound')"></span>
    </div>
      ...
      <table class="table table-striped" aria-describedby="projectcharges">
        <thead>
          <tr>
            ...
            <th scope="row"><span v-text="t$('jHipster3App.projectcharge.projectname')"></span></th>
            <th scope="row"><span v-text="t$('jHipster3App.projectcharge.formid')"></span></th>
            <th scope="row"><span v-text="t$('jHipster3App.projectcharge.secretlevel')"></span></th>
            <th scope="row"><span v-text="t$('jHipster3App.projectcharge.requestdeportment')"></span></th>
            <th scope="row"><span v-text="t$('jHipster3App.projectcharge.chargetype')"></span></th>
            <th scope="row"><span v-text="t$('jHipster3App.projectcharge.chargecontent')"></span></th>
            <th scope="row"><span v-text="t$('jHipster3App.projectcharge.creatorid')"></span></th>
            <th scope="row"></th>
          </tr>
        </thead>
        <tbody>
          <tr v-for="projectcharge in projectcharges" :key="projectcharge.id" data-cy="entityTable">
            ...
            <td v-text="t$('jHipster3App.Secretlevel.' + projectcharge.secretlevel)"></td>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <template #modal-title>
        <span
          id="jHipster3App.projectcharge.delete.question"
          data-cy="projectchargeDeleteDialogHeading"
          v-text="t$('entity.delete.title')"
        ></span>
      </template>
      <div class="modal-body">
        <p id="jhi-delete-projectcharge-heading" v-text="t$('jHipster3App.projectcharge.delete.question', { id: removeId })"></p>
      </div>
