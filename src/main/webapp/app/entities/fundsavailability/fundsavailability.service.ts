...
export default class FundsavailabilityService {
  ...
  public create(entity: IFundsavailability): Promise<IFundsavailability> {
    return new Promise<IFundsavailability>((resolve, reject) => {
      axios
  ...
  public update(entity: IFundsavailability): Promise<IFundsavailability> {
    return new Promise<IFundsavailability>((resolve, reject) => {
      axios
  ...
  public partialUpdate(entity: IFundsavailability): Promise<IFundsavailability> {
    return new Promise<IFundsavailability>((resolve, reject) => {
      axios
