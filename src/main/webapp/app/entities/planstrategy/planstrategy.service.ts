...
export default class PlanstrategyService {
  ...
  public create(entity: IPlanstrategy): Promise<IPlanstrategy> {
    return new Promise<IPlanstrategy>((resolve, reject) => {
      axios
  ...
  public update(entity: IPlanstrategy): Promise<IPlanstrategy> {
    return new Promise<IPlanstrategy>((resolve, reject) => {
      axios
  ...
  public partialUpdate(entity: IPlanstrategy): Promise<IPlanstrategy> {
    return new Promise<IPlanstrategy>((resolve, reject) => {
      axios
