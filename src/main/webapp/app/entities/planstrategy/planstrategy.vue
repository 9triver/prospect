<template>
  <div>
    <h2 id="page-heading" data-cy="PlanstrategyHeading">
      <span v-text="t$('jHipster0App.planstrategy.home.title')" id="planstrategy-heading"></span>
      <div class="d-flex justify-content-end">
        <button class="btn btn-info mr-2" v-on:click="handleSyncList" :disabled="isFetching">
          <font-awesome-icon icon="sync" :spin="isFetching"></font-awesome-icon>
          <span v-text="t$('jHipster0App.planstrategy.home.refreshListLabel')"></span>
        </button>
        <router-link :to="{ name: 'PlanstrategyCreate' }" custom v-slot="{ navigate }">
          ...
          >
            ...
            <span v-text="t$('jHipster0App.planstrategy.home.createLabel')"></span>
          </button>
        </router-link>
      </div>
    </h2>
    ...
    <div class="alert alert-warning" v-if="!isFetching && planstrategies && planstrategies.length === 0">
      <span v-text="t$('jHipster0App.planstrategy.home.notFound')"></span>
    </div>
      ...
      <table class="table table-striped" aria-describedby="planstrategies">
        <thead>
          <tr>
            ...
            <th scope="row"><span v-text="t$('jHipster0App.planstrategy.strategyname')"></span></th>
            <th scope="row"><span v-text="t$('jHipster0App.planstrategy.number')"></span></th>
            <th scope="row"><span v-text="t$('jHipster0App.planstrategy.type')"></span></th>
            <th scope="row"><span v-text="t$('jHipster0App.planstrategy.decument')"></span></th>
            <th scope="row"><span v-text="t$('jHipster0App.planstrategy.responsibleid')"></span></th>
            <th scope="row"><span v-text="t$('jHipster0App.planstrategy.auditorid')"></span></th>
            <th scope="row"></th>
          </tr>
        </thead>
        <tbody>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <template #modal-title>
        <span
          id="jHipster0App.planstrategy.delete.question"
          data-cy="planstrategyDeleteDialogHeading"
          v-text="t$('entity.delete.title')"
        ></span>
      </template>
      <div class="modal-body">
        <p id="jhi-delete-planstrategy-heading" v-text="t$('jHipster0App.planstrategy.delete.question', { id: removeId })"></p>
      </div>
