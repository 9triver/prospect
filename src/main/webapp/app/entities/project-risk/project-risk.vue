    ...
    <div class="table-responsive" v-if="projectRisks && projectRisks.length > 0">
      <el-table :data="projectRisks" style="width: 100%" border stripe fit v-loading="isFetching">
        ...
        <el-table-column
          ...
          prop="nodename"
          :label="t$('jy1App.projectRisk.nodename')"
          :sortable="false"
        >
          <template #default="scope">
            <span class="field-default">{{ scope.row.nodename }}</span>
          </template>
        </el-table-column>
        <el-table-column
          min-width="150px"
          show-overflow-tooltip
          prop="risktype"
          :label="t$('jy1App.projectRisk.risktype')"
          :sortable="true"
        >
          <template #default="scope">
            <span class="field-default">{{ scope.row.risktype }}</span>
          </template>
        </el-table-column>
        <el-table-column
          min-width="150px"
          show-overflow-tooltip
          prop="decumentid"
          :label="t$('jy1App.projectRisk.decumentid')"
          :sortable="false"
        >
          <template #default="scope">
        ...
        <el-table-column min-width="150px" show-overflow-tooltip prop="version" :label="t$('jy1App.projectRisk.version')" :sortable="true">
          <template #default="scope">
            <span class="field-default">{{ scope.row.version }}</span>
          </template>
        </el-table-column>
        <el-table-column min-width="150px" show-overflow-tooltip prop="usetime" :label="t$('jy1App.projectRisk.usetime')" :sortable="true">
          <template #default="scope">
            <span class="field-default">{{ scope.row.usetime }}</span>
          </template>
        </el-table-column>
        <el-table-column
          min-width="150px"
          show-overflow-tooltip
          prop="systemlevel"
          :label="t$('jy1App.projectRisk.systemlevel')"
          :sortable="true"
        >
          <template #default="scope">
            <span class="field-default">{{ scope.row.systemlevel }}</span>
          </template>
        </el-table-column>
        <el-table-column
          min-width="150px"
          show-overflow-tooltip
          prop="risklevel"
          :label="t$('jy1App.projectRisk.risklevel')"
          :sortable="false"
        >
          <template #default="scope">
            <span class="field-fieldIsEnum" v-text="t$('jy1App.Risklevel.' + scope.row.risklevel)"></span>
          </template>
        </el-table-column>
        <el-table-column
          min-width="150px"
          show-overflow-tooltip
          prop="limitationtime"
          :label="t$('jy1App.projectRisk.limitationtime')"
          :sortable="false"
        >
          <template #default="scope">
            <span class="field-default">{{ scope.row.limitationtime }}</span>
          </template>
        </el-table-column>
        <el-table-column
          min-width="150px"
          show-overflow-tooltip
          prop="closetype"
          :label="t$('jy1App.projectRisk.closetype')"
          :sortable="true"
        >
          <template #default="scope">
            <span class="field-default">{{ scope.row.closetype }}</span>
          </template>
        </el-table-column>
        <el-table-column min-width="150px" show-overflow-tooltip prop="riskReport.id" :label="t$('jy1App.projectRisk.riskReport')">
          <template #default="scope">
            <td>
              <div v-if="scope.row.riskReport">
                <router-link :to="{ name: 'RiskReportView', params: { riskReportId: scope.row.riskReport.id } }">{{
                  scope.row.riskReport.id
                }}</router-link>
              </div>
            </td>
          </template>
        </el-table-column>
        <el-table-column min-width="150px" show-overflow-tooltip prop="creatorid.id" :label="t$('jy1App.projectRisk.creatorid')">
          <template #default="scope">
            <td>
        ...
        <el-table-column
          ...
          :label="t$('jy1App.projectRisk.responsibleperson')"
        >
          <template #default="scope">
            <td>
        ...
        <el-table-column min-width="150px" show-overflow-tooltip prop="auditorid.id" :label="t$('jy1App.projectRisk.auditorid')">
          <template #default="scope">
            <td>
        ...
        <el-table-column min-width="150px" show-overflow-tooltip prop="projectwbs.id" :label="t$('jy1App.projectRisk.projectwbs')">
          <template #default="scope">
            <td>
                ...
                <tr v-for="projectRisk in projectRisks"
                    ...
                    <td>
                        <div v-if="projectRisk.riskReport">
                            <router-link :to="{name: 'RiskReportView', params: {riskReportId: projectRisk.riskReport.id}}">{{projectRisk.riskReport.id}}</router-link>
                        </div>
                    </td>
                    <td>
                        <div v-if="projectRisk.creatorid">
                            <router-link :to="{name: 'OfficersView', params: {officersId: projectRisk.creatorid.id}}">{{projectRisk.creatorid.id}}</router-link>
                        </div>
                    </td>
                    <td>
                        <div v-if="projectRisk.responsibleperson">
                            <router-link :to="{name: 'OfficersView', params: {officersId: projectRisk.responsibleperson.id}}">{{projectRisk.responsibleperson.id}}</router-link>
                        </div>
                    </td>
                    <td>
                        <div v-if="projectRisk.auditorid">
                            <router-link :to="{name: 'OfficersView', params: {officersId: projectRisk.auditorid.id}}">{{projectRisk.auditorid.id}}</router-link>
                        </div>
                    </td>
                    <td>
                        <span v-for="(projectwbs, i) in projectRisk.projectwbs" :key="projectwbs.id">{{i > 0 ? ', ' : ''}}
