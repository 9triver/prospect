      ...
      if (this.cycleplan.id) {
        this.cycleplanService()
          ...
          .then(param => {
            this.isSaving = false;
            this.previousState();
            this.alertService.showInfo(this.t$('jHipster3App.cycleplan.updated', { param: param.id }));
          })
          .catch(error => {
            this.isSaving = false;
        ...
        this.cycleplanService()
          ...
          .then(param => {
            this.isSaving = false;
            this.previousState();
            this.alertService.showSuccess(this.t$('jHipster3App.cycleplan.created', { param: param.id }).toString());
          })
          .catch(error => {
            this.isSaving = false;
            this.alertService.showHttpError(error.response);
