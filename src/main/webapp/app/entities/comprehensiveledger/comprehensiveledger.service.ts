...
export default class ComprehensiveledgerService {
  ...
  public create(entity: IComprehensiveledger): Promise<IComprehensiveledger> {
    return new Promise<IComprehensiveledger>((resolve, reject) => {
      axios
  ...
  public update(entity: IComprehensiveledger): Promise<IComprehensiveledger> {
    return new Promise<IComprehensiveledger>((resolve, reject) => {
      axios
  ...
  public partialUpdate(entity: IComprehensiveledger): Promise<IComprehensiveledger> {
    return new Promise<IComprehensiveledger>((resolve, reject) => {
      axios
