...
import { Pbsbaseline } from '@/shared/model/pbsbaseline.model';
...
describe('Service Tests', () => {
  describe('Pbsbaseline Service', () => {
    let service: PbsbaselineService;
    let elemDefault;
    ...
    describe('Service methods', () => {
      ...
      it('should not create a Pbsbaseline', async () => {
      ...
      it('should not update a Pbsbaseline', async () => {
      ...
      it('should not partial update a Pbsbaseline', async () => {
      ...
      it('should not return a list of Pbsbaseline', async () => {
        axiosStub.get.rejects(error);
      ...
      it('should not delete a Pbsbaseline', async () => {
