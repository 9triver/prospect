  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" novalidate v-on:submit.prevent="save()">
        <h2
          id="jHipster0App.projectwbs.home.createOrEditLabel"
          data-cy="ProjectwbsCreateUpdateHeading"
          v-text="t$('jHipster0App.projectwbs.home.createOrEditLabel')"
        ></h2>
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('jHipster0App.projectwbs.projectwbsname')" for="projectwbs-projectwbsname"></label>
            <input
              type="text"
              class="form-control"
              name="projectwbsname"
              id="projectwbs-projectwbsname"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('jHipster0App.projectwbs.wbsspare1')" for="projectwbs-wbsspare1"></label>
            <input
              type="text"
              class="form-control"
              name="wbsspare1"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('jHipster0App.projectwbs.wbsspare2')" for="projectwbs-wbsspare2"></label>
            <input
              type="text"
              class="form-control"
              name="wbsspare2"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('jHipster0App.projectwbs.wbsspare3')" for="projectwbs-wbsspare3"></label>
            <input
              type="text"
              class="form-control"
              name="wbsspare3"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('jHipster0App.projectwbs.wbsspare4')" for="projectwbs-wbsspare4"></label>
            <input
              type="text"
              class="form-control"
              name="wbsspare4"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('jHipster0App.projectwbs.wbsspare5')" for="projectwbs-wbsspare5"></label>
            <input
              type="text"
              class="form-control"
              name="wbsspare5"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('jHipster0App.projectwbs.cycleplan')" for="projectwbs-cycleplan"></label>
          ...
          <div class="form-group">
            <label
              ...
              v-text="t$('jHipster0App.projectwbs.progressmanagement')"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('jHipster0App.projectwbs.qualitymanagement')"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('jHipster0App.projectwbs.fundsmanagement')"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('jHipster0App.projectwbs.technicalmanagement')"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('jHipster0App.projectwbs.contractualfunds')"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('jHipster0App.projectwbs.outsourcingmanagement')"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('jHipster0App.projectwbs.resourcemanagement')"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('jHipster0App.projectwbs.riskmanagement')" for="projectwbs-riskmanagement"></label>
            <select
              class="form-control"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('jHipster0App.projectwbs.securitymanagement')"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('jHipster0App.projectwbs.document')" for="projectwbs-document"></label>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('jHipster0App.projectwbs.safetycheck')" for="projectwbs-safetycheck"></label>
            <select
              class="form-control"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('jHipster0App.projectwbs.department')" for="projectwbs-department"></label>
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('jHipster0App.projectwbs.evaluationCriteria')"
