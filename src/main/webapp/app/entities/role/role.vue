<template>
  <div>
    <h2 id="page-heading" data-cy="RoleHeading">
      <span v-text="t$('jHipster0App.role.home.title')" id="role-heading"></span>
      <div class="d-flex justify-content-end">
        <button class="btn btn-info mr-2" v-on:click="handleSyncList" :disabled="isFetching">
          <font-awesome-icon icon="sync" :spin="isFetching"></font-awesome-icon>
          <span v-text="t$('jHipster0App.role.home.refreshListLabel')"></span>
        </button>
        <router-link :to="{ name: 'RoleCreate' }" custom v-slot="{ navigate }">
          <button @click="navigate" id="jh-create-entity" data-cy="entityCreateButton" class="btn btn-primary jh-create-entity create-role">
            ...
            <span v-text="t$('jHipster0App.role.home.createLabel')"></span>
          </button>
        </router-link>
      </div>
    </h2>
    ...
    <div class="alert alert-warning" v-if="!isFetching && roles && roles.length === 0">
      <span v-text="t$('jHipster0App.role.home.notFound')"></span>
    </div>
      ...
      <table class="table table-striped" aria-describedby="roles">
        <thead>
          <tr>
            ...
            <th scope="row"><span v-text="t$('jHipster0App.role.rolename')"></span></th>
            <th scope="row"><span v-text="t$('jHipster0App.role.description')"></span></th>
            <th scope="row"><span v-text="t$('jHipster0App.role.permission')"></span></th>
            <th scope="row"></th>
          </tr>
        </thead>
        <tbody>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <template #modal-title>
        <span id="jHipster0App.role.delete.question" data-cy="roleDeleteDialogHeading" v-text="t$('entity.delete.title')"></span>
      </template>
      <div class="modal-body">
        <p id="jhi-delete-role-heading" v-text="t$('jHipster0App.role.delete.question', { id: removeId })"></p>
      </div>
