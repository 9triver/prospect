  ...
  <div>
    ...
    >
      ...
      <!-- <el-table-column label="对应项目">
        <template #default="{ row }">
          <router-link v-if="row.id" :to="{ name: 'ProjectwbsOne', params: { ProjectwbsOneId: row.id }  }" custom v-slot="{ navigate }">
...
<script lang="ts" src="./projecttotalwbsTree.component.ts"></script>
