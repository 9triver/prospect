<template>
    ...
    <div style="flex: 3;display: flex;flex-direction: column;">
        <div ref="chart-content-2" style="flex: 1;"></div>
        <div ref="chart-content-3" style="flex: 1;position: relative;"></div>
...
export default {
    ...
    methods: {
        ...
        renderChart3(dataSource) {
            let chart = echarts.init(this.$refs['chart-content-3'])
            let data = dataSource[0];
            this.resetChart3(data, chart);
            return chart;
        },
        // 点击柱状图的时候，环形图重新绘制
        resetChart3(dataItem, chart) {
            let {fee1Total, fee1Contract, fee1Cost, fee2Total, fee2Contract, fee2Cost} = dataItem;
            let option = {
                tooltip: {
                    trigger: 'item',
                ...
                series: [
                    {
                        ...
                        data: [
                            {
                                value: fee2Cost, name: '其他费',
                                itemStyle: {
                                    color: "#deebf7"
                                }
                            },
                            {
                                value: fee1Total+fee2Total-fee1Cost-fee2Cost, name: '空白',
                                tooltip: {
                                    show: false
                                },
                                emphasis: {
                    ...
                    },
                    {
                        ...
                        data: [
                            {
                                value: fee2Contract, name: '其他费',
                                itemStyle: {
                                    color: "#9dc3e6"
                                }
                            },
                            {
                                value: fee1Total+fee2Total-fee1Contract-fee2Contract, name: '空白',
                                tooltip: {
                                    show: false
                                },
                                emphasis: {
                            ...
                            {
                                value: fee1Contract, name: '材料、专用、外协费',
                                itemStyle: {
                                    color: "#f4b183"
                                }
                            },
                    ...
                    },
                    {
                        ...
                        data: [
                            {
                                value: fee2Total, name: '其他费',
                                itemStyle: {
                                    color: "#5b9bd5"
                                }
                            },
                            {
                                value: fee1Total, name: '材料、专用、外协费',
                                itemStyle: {
                                    color: "#ed7d31"
                                }
                            },
    ...
    async mounted() {
        ...
        let chart3 = this.renderChart3(dataSource)
        chart1.on('click', (params) => {
            ...
            if (componentType == 'series') {
                ...
                if (name != this.curDisplayItem) {
                    ...
                    this.resetChart3(dataItem, chart3)
                }
            }
        })
    }
