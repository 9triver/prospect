...
/**
 * REST controller for managing {@link com.cvicse.domain.Department}.
 */
@RestController
...
public class DepartmentResource {
    ...
    public ResponseEntity<Department> updateDepartment(
        ...
        String officerString = String.valueOf(department.getOfficers());
        System.out.println("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
    ...
    public List<Department> getAllDepartments(
        ...
        if ("evaluationcriteria-is-null".equals(filter)) {
            log.debug("REST request to get all Departments where evaluationCriteria is null");
            return StreamSupport.stream(departmentRepository.findAll().spliterator(), false)
