...
/**
 * REST controller for managing {@link com.cvicse.domain.Role}.
 */
@RestController
...
public class RoleResource {
     ...
     */
    @GetMapping("")
    public List<Role> getAllRoles(@RequestParam(name = "filter", required = false) String filter) {
        if ("officers-is-null".equals(filter)) {
            log.debug("REST request to get all Roles where officers is null");
