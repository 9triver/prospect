...
import com.cvicse.service.ProjectremitService;
...
/**
 * Service Implementation for managing {@link com.cvicse.domain.Projectremit}.
 */
@Service
@Transactional
public class ProjectremitServiceImpl implements ProjectremitService {

    private final Logger log = LoggerFactory.getLogger(ProjectremitServiceImpl.class);
