...
public class Technical implements Serializable {
    ...
    @JoinTable(
        name = "rel_technical__projectwbs",
    ...
    public Technical name(String name) {
        this.setName(name);
        return this;
    }
    ...
    public Technical description(String description) {
    ...
    public Technical starttime(LocalDate starttime) {
    ...
    public Technical endtime(LocalDate endtime) {
    ...
    public Technical creatorid(Officers officers) {
    ...
    public Technical auditorid(Officers officers) {
    ...
    public Technical projectwbs(Set<Projectwbs> projectwbs) {
        this.setProjectwbs(projectwbs);
        return this;
    }

    public Technical addProjectwbs(Projectwbs projectwbs) {
        this.projectwbs.add(projectwbs);
        return this;
    }

    public Technical removeProjectwbs(Projectwbs projectwbs) {
    ...
    public boolean equals(Object o) {
        ...
        return getId() != null && getId().equals(((Technical) o).getId());
    }
