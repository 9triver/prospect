...
public interface OutsourcingContractService {
    ...
    /**
     * Get all the outsourcingContracts with eager load of many-to-many relationships.
     *
     * @param pageable the pagination information.
     * @return the list of entities.
     */
    Page<OutsourcingContract> findAllWithEagerRelationships(Pageable pageable);
