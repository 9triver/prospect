...
/**
 * Service Implementation for managing {@link com.cvicse.jy1.domain.OutsourcingPurchaseExecute}.
 */
@Service
@Transactional
public class OutsourcingPurchaseExecuteServiceImpl implements OutsourcingPurchaseExecuteService {

    private static final Logger log = LoggerFactory.getLogger(OutsourcingPurchaseExecuteServiceImpl.class);
