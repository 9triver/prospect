...
import com.cvicse.jy1.service.OutsourcingPurchaseExecuteService;
...
/**
 * REST controller for managing {@link com.cvicse.jy1.domain.OutsourcingPurchaseExecute}.
 */
@RestController
@RequestMapping("/api/outsourcing-purchase-executes")
public class OutsourcingPurchaseExecuteResource {

    private static final Logger log = LoggerFactory.getLogger(OutsourcingPurchaseExecuteResource.class);
    ...
    private final OutsourcingPurchaseExecuteService outsourcingPurchaseExecuteService;

    private final OutsourcingPurchaseExecuteRepository outsourcingPurchaseExecuteRepository;

    public OutsourcingPurchaseExecuteResource(
        OutsourcingPurchaseExecuteService outsourcingPurchaseExecuteService,
        OutsourcingPurchaseExecuteRepository outsourcingPurchaseExecuteRepository
    ) {
        this.outsourcingPurchaseExecuteService = outsourcingPurchaseExecuteService;
    ...
    public ResponseEntity<OutsourcingPurchaseExecute> createOutsourcingPurchaseExecute(
        ...
        outsourcingPurchaseExecute = outsourcingPurchaseExecuteService.save(outsourcingPurchaseExecute);
    ...
    public ResponseEntity<OutsourcingPurchaseExecute> updateOutsourcingPurchaseExecute(
        ...
        outsourcingPurchaseExecute = outsourcingPurchaseExecuteService.update(outsourcingPurchaseExecute);
    ...
    public ResponseEntity<OutsourcingPurchaseExecute> partialUpdateOutsourcingPurchaseExecute(
        ...
        Optional<OutsourcingPurchaseExecute> result = outsourcingPurchaseExecuteService.partialUpdate(outsourcingPurchaseExecute);
    ...
    public List<OutsourcingPurchaseExecute> getAllOutsourcingPurchaseExecutes() {
        ...
        return outsourcingPurchaseExecuteService.findAll();
    }
    ...
    public ResponseEntity<OutsourcingPurchaseExecute> getOutsourcingPurchaseExecute(@PathVariable("id") String id) {
        ...
        Optional<OutsourcingPurchaseExecute> outsourcingPurchaseExecute = outsourcingPurchaseExecuteService.findOne(id);
    ...
    public ResponseEntity<Void> deleteOutsourcingPurchaseExecute(@PathVariable("id") String id) {
        ...
        outsourcingPurchaseExecuteService.delete(id);
