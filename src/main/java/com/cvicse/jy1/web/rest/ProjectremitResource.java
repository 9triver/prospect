...
/**
 * REST controller for managing {@link com.cvicse.jy1.domain.Projectremit}.
 */
@RestController
@RequestMapping("/api/projectremits")
public class ProjectremitResource {

    private static final Logger log = LoggerFactory.getLogger(ProjectremitResource.class);
    ...
    private final ProjectremitService projectremitService;

    private final ProjectremitRepository projectremitRepository;

    public ProjectremitResource(ProjectremitService projectremitService, ProjectremitRepository projectremitRepository) {
        this.projectremitService = projectremitService;
    ...
    public ResponseEntity<Projectremit> createProjectremit(@RequestBody Projectremit projectremit) throws URISyntaxException {
        ...
        projectremit = projectremitService.save(projectremit);
    ...
    public ResponseEntity<Projectremit> updateProjectremit(
        ...
        projectremit = projectremitService.update(projectremit);
    ...
    public ResponseEntity<Projectremit> partialUpdateProjectremit(
        ...
        Optional<Projectremit> result = projectremitService.partialUpdate(projectremit);
    ...
    public List<Projectremit> getAllProjectremits() {
        ...
        return projectremitService.findAll();
    }
    ...
    public ResponseEntity<Projectremit> getProjectremit(@PathVariable("id") String id) {
        ...
        Optional<Projectremit> projectremit = projectremitService.findOne(id);
